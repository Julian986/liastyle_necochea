...
export const SALON_TREATMENTS: SalonTreatment[] = [
  ...
  },
  {
    ...
    name: "Nutrición + Diseño & Tendencias",
    subtitle: "1 h 30 min · $50.000",
    // bookingNote: "Incluye modelado",
    description: "Nutrición capilar con corte diseño y tendencias. Incluye modelado.",
    category: "Cortes y peinado",
  ...
  },
  {
    ...
    name: "Tratamiento + Diseño & Tendencias",
    subtitle: "1 h 30 min · $65.000",
    // bookingNote: "Incluye modelado",
    description: "Tratamiento capilar con corte diseño y tendencias. Incluye modelado.",
    category: "Cortes y peinado",
    durationLabel: "1 h 30 min",
    durationMinutes: 90,
    imageUrl: IMG.corte,
  ...
  },
  {
    ...
    description:
      "Color técnico: diseño de mechas con papel (más de 5 h). Incluye cierre técnico, Plex y modelado. $150.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    description:
      "Color técnico: diseño de mechas con papel (más de 5 h). Incluye cierre técnico, Plex y modelado. $200.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    description:
      "Color técnico: diseño de mechas con papel (más de 5 h). Incluye cierre técnico, Plex y modelado. Desde $250.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    subtitle: "5 h+ · $150.000",
    description:
      "Color técnico: balayage (más de 5 h). Incluye cierre técnico, Plex y modelado. $150.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    subtitle: "5 h+ · $200.000",
    description:
      "Color técnico: balayage (más de 5 h). Incluye cierre técnico, Plex y modelado. $200.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    subtitle: "5 h+ · desde $250.000",
    description:
      "Color técnico: balayage (más de 5 h). Incluye cierre técnico, Plex y modelado. Desde $250.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    subtitle: "5 h+ · $150.000",
    description:
      "Color técnico: air touch (más de 5 h). Incluye cierre técnico, Plex y modelado. $150.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    subtitle: "5 h+ · $200.000",
    description:
      "Color técnico: air touch (más de 5 h). Incluye cierre técnico, Plex y modelado. $200.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    subtitle: "5 h+ · desde $250.000",
    description:
      "Color técnico: air touch (más de 5 h). Incluye cierre técnico, Plex y modelado. Desde $250.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
