...
export const SALON_TREATMENTS: SalonTreatment[] = [
  ...
  },
  {
    ...
    // bookingNote: "El valor puede variar según procesos químicos previos",
    description:
      "Color técnico: balayage con diseño de mechas papel (más de 5 h). Incluye cierre técnico, Plex y modelado. $150.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    // bookingNote: "El valor puede variar según procesos químicos previos",
    description:
      "Color técnico: balayage con diseño de mechas papel (más de 5 h). Incluye cierre técnico, Plex y modelado. $200.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    // bookingNote: "El valor puede variar según procesos químicos previos",
    description:
      "Color técnico: balayage con diseño de mechas papel (más de 5 h). Incluye cierre técnico, Plex y modelado. Desde $250.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    // bookingNote: "El valor puede variar según procesos químicos previos",
    description:
      "Color técnico: air touch con diseño de mechas papel (más de 5 h). Incluye cierre técnico, Plex y modelado. $150.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    // bookingNote: "El valor puede variar según procesos químicos previos",
    description:
      "Color técnico: air touch con diseño de mechas papel (más de 5 h). Incluye cierre técnico, Plex y modelado. $200.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
  },
  {
    ...
    // bookingNote: "El valor puede variar según procesos químicos previos",
    description:
      "Color técnico: air touch con diseño de mechas papel (más de 5 h). Incluye cierre técnico, Plex y modelado. Desde $250.000. El valor puede variar según procesos químicos previos.",
    category: "Color",
    durationLabel: "5 h+",
    durationMinutes: 300,
    imageUrl: IMG.mechas,
