...
const WHATSAPP_LASER =
  ...
  encodeURIComponent(
    "Hola, te escribo de Lia Style Necochea. Consulto por la promo de depilación láser (cavado completo + tira a $17.500).",
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full bg-black/30">
        ...
        <Image
          src={FLYER_SRC}
          alt="Flyer promocional depilación definitiva Lia Style Necochea"
          width={900}
          height={1350}
